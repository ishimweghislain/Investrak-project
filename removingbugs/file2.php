...
<html lang="en">
  <head>
    ...
    <!-- Facebook -->
    <meta property="og:url" content="blog-grid.php">
            ...
            <nav class="navbar navbar-expand-xl bg-transparent px-0 w-100 w-xl-auto">
              ...
              <div class="collapse navbar-collapse mt-3 mt-xl-0" id="primaryMenu02">
                <ul class="navbar-nav hover-menu main-menu px-0 mx-xl-n4">
                  ...
                  <!-- <li id="navbar-item-home" aria-haspopup="true" aria-expanded="false" class="nav-item py-2 py-xl-5 px-0 px-xl-3">
                    <a class="nav-link p-0 active"href="blog.php">Blog</a>
                  </li> -->
                  <li id="navbar-item-home" aria-haspopup="true" aria-expanded="false" class="nav-item py-2 py-xl-5 px-0 px-xl-3">
    ...
    <main id="content">
      <!-- <section class="pb-6 page-title shadow">
        <div class="container">
          ...
          <h1 class="fs-30 lh-16 mb-1 text-dark font-weight-600">Blog grid </h1>
        </div>
      </section> -->
      <section class="py-13 bg-gray-01 mt-10">
        <div class="container">
          ...
          <h2 class="fs-30 lh-16 mb-10 text-dark font-weight-600 text-center">Interesting articles updated frequently</h2>
          <div class="row">
            <?php
              ...
              <div class="card border-0 shadow-xxs-3">
                <div class="position-relative d-flex align-items-end card-img-top">
                  <a href="article.php?c=<?php echo $row['seo_url']; ?>&id=<?php echo $row['post_id']; ?>" class="hover-shine">
                    <img src="http://agency.elimo.rw/resource/post-files/<?php echo $row['image']; ?>"
                ...
                <div class="card-body px-5 pt-3 pb-5">
                  ...
                  <h3 class="fs-18 text-heading lh-15 mb-3">
                    <a href="article.php?c=<?php echo $row['seo_url']; ?>&id=<?php echo $row['post_id']; ?>" class="text-heading hover-primary"><?php echo $row['title']; ?></a>
                  </h3>
                  <p class="mb-3"><?php echo $row['subtitle']; ?></p>
                  <a class="text-heading font-weight-500" href="article.php?c=<?php echo $row['seo_url']; ?>&id=<?php echo $row['post_id']; ?>">Learn more <i
